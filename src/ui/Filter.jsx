...
function Filter({filterField,option}) {
  ...
  const currentField= seachParams.get(filterField)
  function handleClick(value){
    seachParams.set(filterField,value)
    if(seachParams.get('page'))
  ...
  return (
    <StyledFilter>
      ...
      {option.map(opt=> 
      <FilterButton key={opt.value}
       onClick={()=>handleClick(opt.value)}
       active={opt.value === currentField}
       disabled={opt.value === currentField}
       >
